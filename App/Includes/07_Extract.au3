...
; ================         move files from sub-directories to main     ================
    ...
    EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\BWS-FR-Fixpack-1.7.0') Then
		FileWrite($g_LogFile, '>BWS-FR-Fixpack-1.7.0\* .' & @CRLF)
		_Extract_MoveMod('BWS-FR-Fixpack-1.7.0')
	EndIf
